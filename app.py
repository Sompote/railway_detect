...
def run_detection(image_path):
    ...
    command = [
        ...
        "--img", "640",
        "--device", "cpu",
        "--weights", "models/segment/best-2.pt",
    ...
    output_dir = "runs/predict-seg/yolov9_c_640_detect"
    output_image = os.path.join(output_dir, os.path.basename(image_path))
    return output_image

def main():
    st.title("YOLO9tr railway Detection")
    ...
    if uploaded_file is not None:
        ...
        image_path = "combistrail-ed.jpg"  # Default image
